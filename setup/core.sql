...
id int(11) NOT NULL,
  `name` varchar(64) CHARACTER SET latin1 NOT NULL DEFAULT 'anonymous',
  cookie_id varchar(32) CHARACTER SET latin1 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
